...
import { buildFullSchedule, TAPER_PENULTIMATE_RATIO, TAPER_RACE_WEEK_RATIO } from './schedule';
...
export function generateFullPlan(
  ...
  const schedule = buildFullSchedule(weeksToRace, taperWeeks, preferences.targetWeeklyRunMinutes);
